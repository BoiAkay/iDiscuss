<?php
    ...
    {   // detete respective post and comments
...
?>
<!-- Modal -->
<div class="modal fade text-dark" id="delete_post_modal" tabindex="-1" aria-labelledby="delete_post_modalLabel"
    aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="delete_post_modalLabel">Elaborate your concern</h5>
